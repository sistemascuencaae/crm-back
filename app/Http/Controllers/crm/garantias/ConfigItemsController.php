...
class ConfigItemsController extends Controller
{
    ...
    {
        $data = DB::select("select p.pro_id, p.pro_codigo, p.pro_nombre as descripcion, case pc.tipo_servicio when 'G' then 'GEX' when 'S' then 'SEGURO' when 'P' then 'PRODUCTO' end as tipo
