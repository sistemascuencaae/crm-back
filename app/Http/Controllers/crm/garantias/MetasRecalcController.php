...
class MetasRecalcController extends Controller
{
    ...
    {
        $ultimo = MetasRecalc::where('alm_id', $alm_id)->where('mes', $mes)->where('anio', $anio)->max('metare_id');
        ...
        return response()->json(RespuestaApi::returnResultado('success', '200', $ultimo));
    }
